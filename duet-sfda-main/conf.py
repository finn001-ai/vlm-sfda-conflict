...
# Strict eval-only GT feature-capacity probe.  It trains separate 5-fold
# Logistic/MLP probes on real conflicts and never changes formal DUET state.
_C.DUET_CONTEXT.REAL_CONFLICT_GT_PROBE_ENABLED = False
_C.DUET_CONTEXT.REAL_CONFLICT_GT_PROBE_FOLDS = 5
...
# Replace both Task KL and CLIP self-training soft targets on the fixed-coverage
# gate. No second interpolation, auxiliary loss, or hard admission is used.
...
_C.DUET_CONTEXT.CYCLE_CHECKPOINT_SAVE_PATH = ""
_C.DUET_CONTEXT.CYCLE_CHECKPOINT_SAVE_AFTER = 1
_C.DUET_CONTEXT.CYCLE_CHECKPOINT_RESUME_PATH = ""
