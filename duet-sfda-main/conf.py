...
_C.DCCL.RECIPROCAL_BOUNDARY = False
_C.DCCL.BOUNDARY_START_CYCLE = 1
_C.DCCL.BOUNDARY_MAX_PAIRS = 16
_C.DCCL.BOUNDARY_MIN_CONFLICTS = 5
_C.DCCL.BOUNDARY_STABLE_CYCLES = 2
_C.DCCL.BOUNDARY_MIN_ANCHORS_PER_SIDE = 8
_C.DCCL.BOUNDARY_HIDDEN_DIM = 128
_C.DCCL.BOUNDARY_MAX_SHIFT = 0.5
_C.DCCL.BOUNDARY_LR_MULT = 1.0
_C.DCCL.BOUNDARY_MARGIN = 0.5
_C.DCCL.BOUNDARY_MARGIN_PAR = 0.1
_C.DCCL.BOUNDARY_CONSISTENCY_PAR = 0.05
_C.DCCL.BOUNDARY_KEEP_PAR = 0.05
...
_C.DCCL.GTR_CLASS_ROUTING = False
_C.DCCL.GTR_CLASS_ROUTE_MIN_COUNT = 20
_C.DCCL.GTR_CLASS_ROUTE_FLOOR = 0.25
_C.DCCL.GTR_CLASS_ROUTE_MAX_RATIO = 4.0
